...
2026-06-14 13:05 | T-G | main | done | README architecture diagram: full ASCII Tier 0->5 spine with hard-alert fan-out, Z.ai/Telegram/on-chain delivery, and Dream-Mode feedback loop (P_baseline <- sign(λ·P_old+ΣV_safe)). Also: +S6 row to attack-scenario table w/ Dream-Mode A/B note, D-11->D-12 refs, REPORT.md CLEAN-row nota (FP rate ≈0.2% of windows; static θ on baseline noise; real USDC.e=0). Docs only, no code/tests touched.
